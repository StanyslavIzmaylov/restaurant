...
public class MealRestController {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void update(@RequestBody @Validated Meal meal, @PathVariable int menuId) {
        mealService.save(meal, menuId);
    }

    @PostMapping(value = "/{menuId}/meal", consumes = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Meal> createWithLocation(@RequestBody @Validated Meal meal, @PathVariable int menuId) {
